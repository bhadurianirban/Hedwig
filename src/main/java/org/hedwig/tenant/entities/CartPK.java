...
public class CartPK implements Serializable {
    ...
    public CartPK(int id, int tenantId, int prodpackageId, int productId) {
        this.id = id;
    ...
    public String toString() {
        return "org.dgrf.dgrftenant.entities.CartPK[ id=" + id + ", tenantId=" + tenantId + ", prodpackageId=" + prodpackageId + ", productId=" + productId + " ]";
    }
